...
public class DataSeeder implements CommandLineRunner {
    ...
    private void seedUsers(int count) {
        ...
        if (userRepository.findByEmail("super@m.c").isEmpty()) {
            ...
            PlaceOfResidence adminPlace = getOrCreatePlace("Novi Sad", "21000");
        ...
        for (int i = 0; i < count; i++) {
            ...
            String email = (firstName + "." + lastName + i + "@test.com").toLowerCase();
            ...
            String postal = randomPostal();
            PlaceOfResidence place = getOrCreatePlace(city, postal);
    ...
    private PlaceOfResidence getOrCreatePlace(String city, String postalCode) {
        return placeRepo.findByCityAndPostalCode(city, postalCode)
            .orElseGet(() -> placeRepo.save(
    ...
    private LocalDate randomDate() {
        return LocalDate.of(1970 + RANDOM.nextInt(40),
                1 + RANDOM.nextInt(12),
                1 + RANDOM.nextInt(28));
    }

    private LocalDate randomStartDate() {
        return LocalDate.of(2015 + RANDOM.nextInt(10),
                1 + RANDOM.nextInt(12),
                1 + RANDOM.nextInt(28));
    }
}